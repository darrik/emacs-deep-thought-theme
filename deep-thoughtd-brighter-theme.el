;;; deep-thoughtd-brighter-theme.el --- Emacs 24 theme with the Answer to The Ultimate Question
;;;
...
;;; Time-stamp: <2013-03-17 22:06:54>
;;;
...
(custom-theme-set-faces
 ...
 ;; font-lock - syntax
 '(font-lock-builtin-face              ((t (:foreground "#2065a0"))))
 '(font-lock-comment-face              ((t (:foreground "#206f99" :italic t ))))
 '(font-lock-comment-delimiter-face    ((t (:foreground "#2088b2" :italic t ))))
 '(font-lock-doc-face                  ((t (:inherit (font-lock-string-face)))))
 '(font-lock-function-name-face        ((t (:foreground "#2093ce"))))
 '(font-lock-keyword-face              ((t (:foreground "#2a9db7"))))
 '(font-lock-preprocessor-face         ((t (:inherit (font-lock-builtin-face)))))
 '(font-lock-regexp-grouping-backslash ((t (:inherit (bold)))))
 '(font-lock-regexp-grouping-construct ((t (:inherit (bold)))))
 '(font-lock-string-face               ((t (:foreground "#20bdfe"))))
 '(font-lock-constant-face             ((t (:foreground "#2aa9f7"))))
 '(font-lock-type-face                 ((t (:foreground "#2f6e9a"))))
 '(font-lock-variable-name-face        ((t (:foreground "#2e9ec8"))))
...
(provide-theme 'deep-thoughtd-brighter)

;;; deep-thoughtd-brighter-theme.el ends here
